(function (root, factory) {
    ...
    function unindentElement(element, dontStripHTML) {
        var html = unindentText(element.innerHTML);
        if (typeof dontStripHTML != "undefined" || element.hasAttribute('data-unindentor-no-escape')) {
